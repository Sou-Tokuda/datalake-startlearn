...
export class DatabaseConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: DatabaseProps) {
    ...
    this.mssqlInstance = new rds.DatabaseInstance(this, 'MssqlInstance', {
      ...
      backupRetention: cdk.Duration.days(props.config.rds.mssql.backupRetention),
    ...
    // タグ付け
    cdk.Tags.of(this.mssqlInstance).add('Environment', props.config.environment);
    cdk.Tags.of(this.mssqlInstance).add('Project', props.config.projectName);
    cdk.Tags.of(this.auroraCluster).add('Environment', props.config.environment);
