...
export class StorageConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: StorageProps) {
    ...
    // タグ付け
    cdk.Tags.of(this.rawDataBucket).add('Environment', props.config.environment);
    cdk.Tags.of(this.rawDataBucket).add('Project', props.config.projectName);
    cdk.Tags.of(this.processedDataBucket).add('Environment', props.config.environment);
    cdk.Tags.of(this.processedDataBucket).add('Project', props.config.projectName);
    cdk.Tags.of(this.s3TablesBucket).add('Environment', props.config.environment);
    cdk.Tags.of(this.s3TablesBucket).add('Project', props.config.projectName);
    cdk.Tags.of(this.scriptsBucket).add('Environment', props.config.environment);
